...
//            this.add(menuBar, { left: "0%", right: "0%", top: "0%" });
            ...
            this.m_gridVar = fv.makeGlobalVariable("/MainWindow/GridToggle", (function(){
                this.m_gridToggle.setValue( this.m_gridVar.get() === "1");
            ...
            this.m_gridToggle.addListener("execute", function () {
                this._emit("ui.mainWindow.grid.visible", this.m_gridToggle.getValue());
                this.m_gridVar.set( this.m_gridToggle.getValue() ? "1" : "0");
            }, this);
...
//            }, this);
            ...
            function bindToggleToState(toggle, path) {
                var gVar = fv.makeGlobalVariable( path, function() {
                    fv.console.log( "xyz gvarcb:", gVar.get());
                    toggle.setValue( gVar.get() === "1");
                }, false);
                toggle.addListener( "changeValue", function(){
                    fv.console.log( "xyz tgl cvcb:", toggle.getValue());
                    if( toggle.getValue() === null) return;
                    gVar.set( toggle.getValue() ? "1" : "0");
                });
            }

            this.m_gauss2dToggle = this.addToolToggle("Gauss.fit");
//            this.m_gauss2dToggle.setCommand( this.m_commands.g2dfit);
            bindToggleToState( this.m_gauss2dToggle, "/G2D/windowActive");

            this.m_regionStatsToggle = this.addToolToggle("Region");
//            this.m_regionStatsToggle.setCommand( this.m_commands.regionStats);
            bindToggleToState( this.m_regionStatsToggle, "/RegionStats/windowActive");
...
//            this.m_threeDsurfacePlotToggle.setCommand( this.m_commands.threeDsurfacePlot);
            bindToggleToState( this.m_threeDsurfacePlotToggle, "/Plot3d/windowActive");
...
//                this._emit("toui.windowManager.setVisibility",
//                    { id: "threeDsurfacePlot",
//                        visibility: !this.m_threeDsurfacePlotToggle.getValue()
//                    });
            },
