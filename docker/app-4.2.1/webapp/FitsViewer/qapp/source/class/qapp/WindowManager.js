...
qx.Class.define(
    "qapp.WindowManager",
    {
        ...
        construct: function (hub, root, boundsWidget) {
            ...
            this.m_hub.subscribe( "toui.windowManager.setVisibility", this._setVisibilityCB, this);

//            this.m_gVars = {};
//            this.m_gVars.threedWindowVisible = fv.makeGlobalVariable(
//                "/Plot3d/windowActive",
//                function(val){
//                    if(val === "1") this._show("threeDsurfacePlot");
//                    else this._hide("threeDsurfacePlot");
//                }.bind(this), false);
            this._linkWindowVisibilityToState( "threeDsurfacePlot", "/Plot3d/windowActive");
            this._linkWindowVisibilityToState( "regionStats", "/RegionStats/windowActive");
            this._linkWindowVisibilityToState( "g2dFit", "/G2D/windowActive");
        ...
        members: {
            ...
            _linkWindowVisibilityToState: function( id, path) {
                fv.makeGlobalVariable(
                    path,
                    function(val){
                        if(val === "1") this._show(id);
                        else this._hide(id);
                    }.bind(this), false);
            },
            ...
            _setVisibilityCB: function( data) {
                fv.console.log( "xyz", data);
                var id = data.id;
                var vis = data.visibility;
                vis = !! vis;
                if( this._isVisible(id) == vis) return;
                if( vis) this._show(id); else this._hide(id);
            },
