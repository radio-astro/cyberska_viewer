...
//            this.setAppearance( "MainSideBar");
            ...
            this.m_gVars.currentStokes = fv.makeGlobalVariable(
                "/currentStokes", this._currentStokesCB.bind(this));
        },

        members: {

            _currentStokesCB: function( val) {
                return;
                if( val == null) return;
                var a = val.split("_");
                ...
                a[1] = parseInt( a[1]);
                if(a[1] < 2) {
                    this.stokesPane.setVisibility( "excluded");
                } else {
                    this.stokesPane.setVisibility( "visible");
                }
            },
            ...
            _loadedImageTypeCB: function( val) {
                ...
                else if( val === "iqu-fake" || val === "4diquv") {
            ...
            _buttonPushed: function (id) {
                if( id === "ix-profile") {
                    ...
                    this.m_gVars.currentStokes.set( "0");
                }
                else if( id === "stokesQ") {
                    this.m_gVars.currentStokes.set( "1");
                }
                else if( id === "stokesU") {
                    this.m_gVars.currentStokes.set( "2");
                }
                else if( id === "stokesV") {
                    this.m_gVars.currentStokes.set( "3");
                }
                else {
...
//                }, this);
                ...
                // Stokes controls
                this.stokesPane = new qx.ui.container.Composite(new qx.ui.layout.VBox());
                this.stokesPane.add(new qx.ui.basic.Label("Stokes").set({
                    appearance: "MainSideBar-label"
                }));
                this._stokesButtons = {};
                var stokesContainer = new qx.ui.container.Composite(new qx.ui.layout.Flow(3, 3, "center"));
                this.stokesPane.add(stokesContainer);
                this._stokesButtons.i = butt("I", "stokesI", stokesContainer, {});
                this._stokesButtons.q = butt("Q", "stokesQ", stokesContainer, {});
                this._stokesButtons.u = butt("U", "stokesU", stokesContainer, {});
                this._stokesButtons.v = butt("V", "stokesV", stokesContainer, {});

                this.add(this.stokesPane);
            },
            m_hub: null,
